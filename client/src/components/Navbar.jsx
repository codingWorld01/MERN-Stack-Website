        ...
        <nav>
            ...
            <ul>
...

                {
                    (isLoggedIn) ?
                        <>
                            <li className="linked"><NavLink to="/contact">Contact</NavLink></li>
                            <li className="linked"><NavLink to="/logout">Logout</NavLink></li>
                        </>
                        :
                        <>
                            <li className="linked"><NavLink to="/login">Login</NavLink></li>
                            <li className="linked"><NavLink to="/register">Signup</NavLink></li>
                        </>
                }
